...
var language = {
  ned: {
    ...
    landNav5: 'Pakketten',
    firstPartTextPara: 'Wij gaan u helpen met uw website ideeën en zullen ze uitvoeren als het mogelijk is! <br/> Wij gaan voor u en uw bedrijf een website maken vanaf maar <strong class="price">€9</strong><small class="raleway">.99!</small>',
    fiverrTopH2: ' Contact <br/><var>Bericht <br/>Benader <br/>Werk Met </var>',
    fiverrTopParagraph: "Contacteer ons over wat u van plan bent en dan zullen we u zo snel mogelijk terug mailen over <strong>wat wij voor u kunnen betekenen!</strong> Weet u nog niet zeker wat u gedaan wilt hebben?<strong> Wij helpen u!</strong>",
